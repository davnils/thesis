...
It accepts two input dates, which determine the time period of interest.
...
\image{solar-plane}{solar-plane-plot}{Solar plane density plot}{
  Density plot in the solar plane showing that many paths occur close to the boundaries.
}
...
\subimage{solar-plane-faults}{solar-plane-faults-plot}{TBD}{
  % parameters used: epsilon 8, min pts 3, distance function: eucledian distance R^2
  Plot of the solar plane with two coloured clusters of shading faults, and real faults marked with crosses.
}
{0.48}
~
