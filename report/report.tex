...
The scope and constraints of this thesis are described and put into the context of the field of PV power electronics.

\section{Overview of fault detection}
Photovoltaic power generation has gradually become an increasingly larger source of power generation during the last few decades (source).
This trend has been matched with research into more efficient solar panels (TODO: REF), with the current record being TODO.
In addition research into the solar panels there is also interest in the surrounding equipment (TODO: REF).

Part of these systems are power inverters converting DC energy from the solar panels to the AC grid output.
Recently this area has progressed to distributed systems of inverters where a small inverter module is connected to every panel (TODO: REF).
In addition to increased efficiency, this also allows individual measurements of solar panels.
These new capabilities render new possibilities in monitoring of the health of solar panels.
...
From an ethical prespective this thesis has mainly a positive impact in three different ways.
...
Studies have shown.. %TODO: Fix reference and shit

Secondly, the early detection of faulty panels results in less faulty panels being present in installations.
This implies a reduction in risk of fire hazards(TODO: REF) which may affect both personell and installed equipment.
...
In the long term this implies cheaper installations and better sustainability for photovoltaic systems.
