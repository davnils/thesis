...
%TODO: Need to add figure caption on the format "Figure 1. Equivalent circuit.."
\begin{figure}[!ht]
\centering
...
\image{trina-60cell-iv-alpha.png}{trina-iv-curve}{Solar cell IV-curve characteristic}{
  Typical IV-curve of a solar cell. Note the non-linear relationship between voltage and current, and the effect of solar irradiation on output current.
}
